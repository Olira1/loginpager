// Seed TiDB Cloud Database with Complete Test Data
// Run this with: node seed-tidb-database.js
// Run AFTER: node setup-tidb-database.js
...
async function seedDatabase() {
  ...
  try {
    ...
    // 11. Students for Class 9A (user ids: 13-22)
    ...
    // 19. Henok (id=29), Rahel (id=30), Fikadu (id=31)
    await connection.query(`
      INSERT INTO users (name, email, password, phone, role, school_id) VALUES
    ...
    // 20. Students for 10A (user ids: 32-41)
    ...
    // 21. Parents for 10A (user ids: 42-46)
    ...
    // 22. Teaching Assignments for 10A
