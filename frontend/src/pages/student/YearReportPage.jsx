// Year Report Page - Combined annual performance across both semesters
// Matches Parent Portal Year Report design
    ...
    <div className="space-y-6">
      ...
      {report ? (
        <div className="bg-white border-2 border-gray-300 rounded-xl p-6">
          ...
          {/* Semester Summaries - compact format like Parent */}
          ...
          {/* Subjects Table - SUBJECT, SEM 1, SEM 2, YEAR AVG */}
          ...
          {/* Year Summary - Year Total, Year Average, Students, Remark */}
